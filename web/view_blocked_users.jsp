...
if(mobileno!=null)
{
UserDTO unblockuser=new UserDTO();
unblockuser.setMobileno(mobileno);
UserDAO.unBlockUser(unblockuser);
}
                              ...
                              <table style="width:100%">
                                  <tr>
                                     ...
                                     <th style="padding:15px">Registration date</th>
                                        ...
                                        <%
                          ArrayList<UserDTO> users=UserDAO.getBlockedUserList();
                            for(UserDTO user : users)
                              ...
                              <tr>
                                  ...
                                  <!-- <td style="padding:15px"><a href="view_users.jsp?&mobileno=<%=user.getMobileno()%>" >Block User</a></td> -->
                                     <td style="padding:15px"><a onclick="f1()" href="view_blocked_users.jsp?&mobileno=<%=user.getMobileno()%>" >Unblock User</a></td>  
