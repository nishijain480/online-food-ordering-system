...
<%
    ...
    if (btn != null && btn.equals("Sign Up")) {
       ...
       if(user!=null) 
       {
         // out.println("Thanks for Signup");
         session.setAttribute("USER",user);
        // out.println("correct otp");
         //out.println(user.getOtp());
    SendSMS.send(user.getMobileno(), "HELLO " + user.getFullname() + "," + user.getOtp() + " This is your otp for Thefood ");
       response.sendRedirect("otp100.jsp");
    }
  }
// SIGN IN MODULE  
    if(btn!=null && btn.equals("Sign In"))
    {
        ...
        UserDTO user =new UserDTO();
        user.setMobileno(request.getParameter("umob"));
        user.setUpass(request.getParameter("upass"));
    
    
        user=(UserDTO)(UserDAO.chkLogin(user.getMobileno(),user.getUpass()));
         // out.println("valid user");  
        if(user!=null)
          {
           session.setAttribute("USER",user);
           out.println("valid user");
          response.sendRedirect("index100.jsp");
          }
          else
          {
            out.println("Please SignUP first");  
          response.sendRedirect("registration100.jsp");
          }
                        ...
                        <div class="register-box">
                            ...
                            <div  class="tab-content">
                                <div class="tab-pane fade active in" id="signin">
                                    ...
                                    <form class="form-horizontal" method="post" action="registration100.jsp">
                                        <fieldset>
                                            <!-- Sign In Form -->
                                            <!-- Text input-->
                                ...
                                <div class="tab-pane fade" id="signup">
                                    ...
                                    <form method="POST" action="registration100.jsp" class="form-horizontal">
                                        <fieldset>
                                            <!-- Sign Up Form -->
                                            <!-- Text input-->
