...
<head>
    ...
    <!--BOOTSTRAP MY CSS AND OTHER ALSO -->
...
<body class="home">
    <script>
        function f1()
        {
            var x=document.getElementById("nishi");
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse" >
                        ...
                        <ul  class="nav navbar-nav" >
                             <li class="nav-item"> <a  class="nav-link active" href="index100.jsp">Home <span class="sr-only">(current)</span></a> </li>
                             <li  class="nav-item" > <a   class="nav-link active" href="#" onMouseOut="f2()" onMouseOver="f1()" >Categories&nbsp;<span class='glyphicon glyphicon-menu-down'></span> <span class="sr-only">(current)</span></a> 
                                            
                                      <ul id="nishi" style="list-style:none;position:absolute;display:none;z-index:2;">
                                           <%
                                               ArrayList <CategoryDTO> categories=CategoryDAO.getCategoryList();
                                                      for( CategoryDTO category: categories)
                              {
                                               %>
 <li  onMouseOver="f1()" onMouseOut="f2()" style=" background-color:red; width:130px;height:50px;z-index:2;text-decoration:none;line-height: 50px;
      border:3px solid red; width:90px; text-align:center;  float:left; position:relative; "  ><a style="text-decoration:none; color:white;display:block;" onMouseOver="this.style.color='black'" href="view_item100.jsp?&catid=<%=category.getCatid()%>&catnm=<%=category.getCatnm()%>"><%=(category.getCatnm()).toUpperCase()%></a></li>
                                        <% 
                                        }
                                        %>
                                     </ul>
                            ...
                            <li class="nav-item"> <a  class="nav-link active" href="index100.jsp">Contact Us<span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a  class="nav-link active" href="index100.jsp">Support <span class="sr-only">(current)</span></a> </li>
                       <!--      <li class="nav-item">  <a class="nav-link active" href="index.html"> Cart<span class="sr-only">(current)</span></a> </li>     -->
                            <li class="nav-item" ><a  class="nav-link active" href="cart100.jsp"> <img src="images/shopping_cart3.png" height="30" width="30" />cart(<%=selecteditems.size() %>)<span class="sr-only">(current)</span></a></li>
                            <%
                            if(user==null)
                            {
                            %> 
                           <li class="nav-item"> <a  class="nav-link active" href="registration100.jsp"> <img width="23" src="images/user.png">  
                           ...
                           {
                            %>
                          <li class="nav-item"> <a  class="nav-link active" href="index100.jsp"><!-- <img width="23" src="images/user.png">   -->
                          Welcome! <%=user.getFullname()%> <span class="sr-only">(current)</span></a> </li>       
       ...
       <!--  <div class="location-match text-xs-center">
        ...
        <!--  first Popular block of the day starts -->
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular dishes of the day</h2>
                ...
                %>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="images/dosa.jpg">
                                <div class="distance"><div class="mins"><i class="fa fa-motorcycle"></i> 30 min</div></div>
                                <!-- <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div> -->
                                <!-- <div class="review pull-right"><a href="#">198 reviews</a> </div> -->
                            </div>
                            <div class="content">
                                <h5><a href="profile.html"><%=item.getCat().getCatnm()%></a></h5>
                                <div class="product-name"><%=item.getItemnm()%></div>
                                <div class="price-btn-block"> <span class="price"><%=item.getItemprice()%></span> <!--   <a href="#" class="btn theme-btn-dash pull-right">Order Now</a> -->  
                                                                                                                  
                           
                                    <form action="index100.jsp" method="post">
                              <!--      <a href="index.jsp" class="btn theme-btn-dash pull-right">Order Now</a>     -->
         ...
         <!--  first Popular block for month starts here -->
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            ...
                            <div class="content">
                                <h5><a href="profile.html">The South"s Best Masala Dosa</a></h5>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="images/pizza.jpg">
                                <div class="distance"><div class="mins"><i class="fa fa-motorcycle"></i> 30 min</div></div>
                                <!-- <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div> -->
                                <!-- <div class="review pull-right"><a href="#">198 reviews</a> </div> -->
                            </div>
                            <div class="content">
                                <h5><a href="profile.html"> Chinese Best Pizza</a></h5>
                                <div class="product-name">Chess Pizza</div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="images/pizza2.jpg">
                                <div class="distance"><div class="mins"><i class="fa fa-motorcycle"></i> 30 min</div></div>
                                <!-- <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                <div class="review pull-right"><a href="#">198 reviews</a> </div> -->
                            </div>
                            <div class="content">
                                <h5><a href="profile.html">The cheesy paneer pizza</a></h5>
                                <div class="product-name">Paneer pizza</div>
        ...
        <section class="popular" >
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="images/chilly_panner_pizza.jpg">
                                <div class="distance"><div class="mins"><i class="fa fa-motorcycle"></i> 30 min</div></div>
                                <!-- <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                <div class="review pull-right"><a href="#">198 reviews</a> </div> -->
                            </div>
